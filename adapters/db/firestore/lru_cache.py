...
class LRUCache:
    ...
    def __init__(self, capacity: int = 128, ttl_s: int = 5) -> None:
        ...
        self._capacity = max(1, capacity) # Capacity
        self._ttl_s = max(1, ttl_s) # TTL
    ...
    def delete(self, key: str) -> None:
        """Delete a value from the LRU cache."""
    ...
    def keys(self) -> Iterable[str]:
        """Get all keys from the LRU cache."""

        with self._lock:
            return list[str](self._data.keys())
